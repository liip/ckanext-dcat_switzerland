...
setup(
    ...
    description='''CKAN extension for managing datasets in the DCAT-AP CH Format.''',
    ...
    keywords='''CKAN opendataswiss switzerland suisse helvetica schweiz dcat-ap-ch dcat-ap''',
